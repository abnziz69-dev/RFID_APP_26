                    ...
                    Column(
                      ...
                      children: [
                        Align(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              context.pushNamed(SavedTagPageWidget.routeName);
                            },
                            text: 'Veiw Saved Tags',
                            options: FFButtonOptions(
                              height: 40.0,
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  16.0, 0.0, 16.0, 0.0),
                        ...
                        children: [
                          ...
                          Stack(
                            children: [
                              ...
                              if (_model.scanStatus == 'existing_tag')
                                Align(
                                  alignment: AlignmentDirectional(-0.46, 0.0),
                                  child: Text(
                                    valueOrDefault<String>(
                                      _model.scanStatus,
                                      'Tag already assigned to a product',
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    isDense: true,
                                    labelText: _model.currentTagCode,
